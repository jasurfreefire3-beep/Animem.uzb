      ...
      >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-3 bg-[#111] text-white/40 uppercase tracking-wide font-bold">Or continue with</span>
          </div>
        </div>
        ...
        <button 
          ...
          type="button"
          className="w-full bg-white text-black font-bold py-3 px-4 rounded-sm hover:bg-gray-200 transition-colors flex items-center justify-center space-x-2"
        >
